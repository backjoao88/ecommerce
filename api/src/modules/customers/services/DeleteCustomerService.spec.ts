...
describe('DeleteCustomer', () => {
  it('shoud be able to delete a customer', async () => {
    ...
    const deleteCustomerService = new DeleteCustomerService(fakeCustomerRepository);
    ...
    const customer = await deleteCustomerService.execute({ id: newCustomer.id });
